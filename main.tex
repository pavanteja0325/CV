...
\item \textbf{Focus Areas:} Usable privacy, Human-Computer Interaction, User mental models, Privacy regulation
\end{itemize}
...
\item Designed an exploratory survey (n=259) to understand the perspectives of the educated, English-speaking subset of the Indian population
\item Analyzed the mixed-methods design using Friedman \& Mann-Whitney U tests, Spearman correlations, and ordinal/linear regression with Holm correction and reflexive thematic analysis
\item Identified the gap between users' privacy concerns, their varied personal data sensitivities, and the provisions of the law expecting uniformity 
\item Found near-null demographic effects on users' personal data sensitivity and perceived control over its processing, indicating an underlying consensus of distrust towards organizations and their data processing practices
\end{itemize}
\vspace{4pt}
